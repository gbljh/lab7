...
namespace _7
{
    public partial class fMain : Form
    {
        ...
        private void btnCount_Click(object sender, EventArgs e)
        {
            ...
            double y = (0.1*x1*Math.Sin(x2)* Math.Pow(Math.Cos(x1),4))+55;
            tbY.Text = y.ToString("0.##E+00");
            if (x1 > x2){
                tbXmax.Text = x1.ToString("0.##E+00");
            }
            else {
                tbXmax.Text = x2.ToString("0.##E+00");
            }
        }
    }
}
